export default [
  ...
  {
    constant: false,
    inputs: [{ name: '_maxBNBPurchase', type: 'uint256' }],
    name: 'setMaxBNBPurchase',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
    signature: '0x93e5b088',
  },
  {
    constant: false,
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'guaranteedOikosRate', type: 'uint256' },
    ],
  ...
  { payable: true, stateMutability: 'payable', type: 'fallback' },
  {
    ...
    name: 'MaxBNBPurchaseUpdated',
    type: 'event',
    signature: '0xa3dcc875278975f25cff57788c81b6fdb265d78bb516c7453b5412f2d015e24a',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: 'fromBNBAmount', type: 'uint256' },
      { indexed: false, name: 'toAmount', type: 'uint256' },
      { indexed: true, name: 'depositIndex', type: 'uint256' },
    ],
    name: 'ClearedDeposit',
