...
import abi from '../../../lib/abis/testnet/Oikos';
...
function Oikos(contractSettings) {
   ...
   * @returns boolean
   **/
  this.anySynthOrOKSRateIsStale = async () => {
    return await this.contract.anySynthOrOKSRateIsStale();
  };
   ...
   **/
  this.oUSD = async () => {
    return await this.contract.oUSD();
  };
