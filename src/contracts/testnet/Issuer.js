...
import abi from '../../../lib/abis/testnet/Issuer';
...
function Issuer(contractSettings) {
   ...
   * @returns Object
   **/
  this.transferableOikosAndAnyRateIsStale = async (account, balance) => {
    return await this.contract.transferableOikosAndAnyRateIsStale(account, balance);
  };
}
