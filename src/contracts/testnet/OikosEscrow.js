...
import abi from '../../../lib/abis/testnet/OikosEscrow';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function OikosEscrow(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList['OikosEscrow'],
    abi,
