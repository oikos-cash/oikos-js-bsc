...
import abi from '../../../lib/abis/bsc/VBNBCollateraloUSD';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function VBNBCollateraloUSD(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList['VBNBCollateraloUSD'],
    abi,
  ...
  /**
   * Transaction (consumes gas, requires signer)
   * @param _vToken {String<EthAddress>}
   * @param txParams {TxParams}
  
   **/
  this.setVToken = async (_vToken, txParams) => {
    txParams = txParams || {};
    return await this.contract.setVToken(_vToken, txParams);
  };
...
export default VBNBCollateraloUSD;
