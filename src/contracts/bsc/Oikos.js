...
import abi from '../../../lib/abis/bsc/Oikos';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function Oikos(contractSettings) {
  ...
  /**
   * Only the contract owner may call this., Remove an associated Synth contract from the Oikos system.<br>
   * Transaction (consumes gas, requires signer)
  ...
  /**
   * Only the contract owner may call this., Add an associated Synth contract to the Oikos system.<br>
   * Transaction (consumes gas, requires signer)
   ...
   * @returns BigNumber
   **/
  this.transferableOikos = async account => {
    return await this.contract.transferableOikos(account);
  };
